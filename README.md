> Автоматическая запись к врачу в Поликлиника 3. Гомеля на сайте [tutmed.by](https://tutmed.by) + Telegram-уведомления. (возможно при модификации кода записываться и к другую полеклинику). 
